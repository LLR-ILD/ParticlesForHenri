...
namespace convert {
  ...
  public:
     ...
     */
    static void dumpEventDetailed(const EVENT::LCEvent* evt, string OutDirName);
     ...
     */
    static void printMCParticles(const EVENT::LCCollection* col,FILE *kinFile);
     ...
     */
    static void printSimCalorimeterHits(const EVENT::LCCollection* col, int pP,
					FILE *hitFile ) ;
